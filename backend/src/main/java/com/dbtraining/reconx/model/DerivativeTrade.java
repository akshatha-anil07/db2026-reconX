...
public final class DerivativeTrade implements TradeType {
    ...
    @Override public String toString() {
        ...
        // NOTE: Deliberately omit counterpartyId and tradeDate from logs; use the audit formatter if full detail is ever needed.
    }

    /**
     * Fluent builder for an immutable {@link DerivativeTrade}.
     */
