...
public final class DerivativeTrade implements TradeType {
    ...
    @Override public String toString() {
        ...
        return "DerivativeTrade[ref=%s, %s %s on %s, strike=%s %s, qty=%s, expiry=%s, side=%s]".formatted(tradeRef, optionType, underlying, tradeDate, strike.toPlainString(), currency.getCurrencyCode(), quantity, expiry, side);
    }
