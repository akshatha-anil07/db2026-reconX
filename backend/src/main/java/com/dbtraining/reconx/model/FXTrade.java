...
public final class FXTrade implements TradeType {
    ...
    @Override public String toString() {
        ...
        return "FXTrade[ref=%s, %s/%s, notional=%s %s, rate=%s, side=%s]".formatted(tradeRef, ccy1.getCurrencyCode(), ccy2.getCurrencyCode(),notionalCcy1, ccy1.getCurrencyCode(), fxRate, side);
    }
